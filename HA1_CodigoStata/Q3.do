 ...
 * Plot the level of CIW and labor supply by zone against the level of household income by zone
 ...
 preserve
	 ...
	 graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 1\figures\figure14.png", replace
 restore

 preserve
	 drop if district_code =="413" // drop outlier
	 ...
	 graphregion(color(white))
	 graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 1\figures\figure15.png", replace
 restore
 ...
 preserve
	 ...
	 graphregion(color(white))
	 graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 1\figures\figure16.png", replace
 restore
 ...
 * Plot the inequality of CIW and labor supply by zone against the level of household income by zone
 ...
 preserve
	 scatter v_intensive consumption || lfit v_intensive consumption, ytitle("Mean var log hours worked", size(medlarge)) ///
	 ylabel(, labsize(medlarge) noticks nogrid) xtitle("Log-mean consumption", size(medlarge)) ///
	 graphregion(color(white))
	 graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 1\figures\figure17.png", replace
 restore
 
 preserve
	 drop if district_code =="413" // drop the outlier
	 
	 scatter v_intensive income || lfit v_intensive income, ytitle("Mean var log hours worked", size(medlarge)) ///
	 ylabel(, labsize(medlarge) noticks nogrid) xtitle("Log-mean income", size(medlarge)) ///
	 graphregion(color(white))
	 graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 1\figures\figure18.png", replace
 restore
 
 preserve
	 scatter v_intensive wealth || lfit v_intensive wealth, ytitle("Mean hours worked", size(medlarge)) ///
	 ylabel(, labsize(medlarge) noticks nogrid) xtitle("Log-mean wealth", size(medlarge)) ///
	 graphregion(color(white))
	 graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 1\figures\figure19.png", replace
 restore
 ...
 ** Create a local variable with the different districts
 ...
 preserve
	 ...
	 graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 1\figures\figure20.png", replace
 restore
 ...
 preserve
	 ...
	 ylabel(, labsize(medlarge) noticks nogrid) xtitle("Log-mean wealth", size(medlarge)) ///
	 graphregion(color(white)) legend(off)
	 graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 1\figures\figure21.png", replace
 restore
 ...
 preserve
	 ...
	 ylabel(, labsize(medlarge) noticks nogrid) xtitle("Log-mean consumption", size(medlarge)) ///
	 graphregion(color(white)) legend(off)
	 graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 1\figures\figure22.png", replace
 restore 
