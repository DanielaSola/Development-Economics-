 ...
 *** Merge all the datasets 
 use "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 1\output\final_dataset.dta", clear
 ...
 *** Average CIW for rural and urban areas
 ...
 mean consumption[pw=wgt_X] if urban==0 // Mean annual consumption in rural areas 
 mean consumption[pw=wgt_X] if urban==1 // Mean annual consumption in urban areas
 mean income [pw=wgt_X] if urban==0 // Mean annual income in rural areas   
 mean income [pw=wgt_X] if urban==1 // Mean annul income in urban areas 
 mean wealth [pw=wgt_X] if urban==0 // Mean annual wealth in rural areas 
 mean wealth [pw=wgt_X] if urban==1 // Mean annual wealth in urban areas 
 ...
 *** Histogram for CIW for rural and urban areas  
 ...
 twoway (histogram consumption if urban==0, fcolor(none) lcolor(gray)) ///
 (histogram consumption if urban==1, fcolor(none) lcolor(pink)), ///
 legend(order(1 "Rural" 2 "Urban")) xtitle(Consumption) graphregion(color(white)) 
 graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 1\figures\hist1.png", replace 
 
 twoway (histogram income if urban==0, fcolor(none) lcolor(gray)) ///
 (histogram income if urban==1, fcolor(none) lcolor(pink)), ///
 legend(order(1 "Rural" 2 "Urban")) xtitle(Income) graphregion(color(white)) 
 graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 1\figures\hist2.png", replace 

 twoway (histogram wealth if urban==0, fcolor(none) lcolor(gray)) ///
 (histogram wealth if urban==1, fcolor(none) lcolor(pink)), ///
 legend(order(1 "Rural" 2 "Urban")) xtitle(Wealth) graphregion(color(white)) 
 graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 1\figures\hist3.png", replace 
 ...
 *** Variance of logs for CIW for rural and urban areas
 ...
 mean v_consumption [pw=wgt_X] if urban== 0 
 mean v_consumption [pw=wgt_X] if urban== 1 
 mean v_income [pw=wgt_X] if urban== 0 
 mean v_income [pw=wgt_X] if urban== 1 
 mean v_wealth [pw=wgt_X] if urban== 0 
 mean v_wealth [pw=wgt_X] if urban== 1 
 ...
 ** CIW level over the lifecycle
 ...
 preserve
	 ...
	 graph twoway (line income_lc age, fcolor(none) lcolor(pink)) ///
	 (line wealth_lc age, fcolor(none) lcolor(gray)) ///
	 (line consumption_lc age, fcolor(none) lcolor(green)), ///
	 ...
	 graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 1\figures\figure1.png", replace
 ...
 ** CIW inequality over the lifecycle
 ...
 preserve 
	...
	graph twoway (line v_income_all age, fcolor(none) lcolor(pink)) ///
	(line v_wealth_all age, fcolor(none) lcolor(gray)) ///
	(line v_consumption_all age, fcolor(none) lcolor(green)), ///
	legend(order(1 "Var of log-income" 2 "Var of log-wealth" 3 "Var of log-consumption")) xtitle("Age") ///
	xlabel(15(10)70, labsize(medlarge) noticks grid angle(0)) ///
	ylabel(, labsize(medlarge) nogrid) graphregion(color(white))
	graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 1\figures\figure2.png", replace
