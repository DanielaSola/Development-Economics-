...
histogram beta, title("Coefficient Beta across households", color(black)) xtitle ("Betas") graphregion(color(white)) bcolor(blue)
graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 3\HistBeta.png", replace 
restore
...
histogram phi, title("Coefficient Phi across households", color(black)) xtitle ("Phis") graphregion(color(white)) bcolor(pink) 
graph export "C:\Users\Usuario\Desktop\CEMFI\Term 5\Development\HA\HA 3\HistPhi.png", replace 
restore
 ...
 * Define five income groups
 ...
 gen income_group = 0
 replace income_group = 1 if nhh<=576
 replace income_group = 2 if nhh>576 & nhh<=1152
 replace income_group = 3 if nhh>1152 & nhh<=1728
 replace income_group = 4 if nhh>1728 & nhh<=2304
 replace income_group = 5 if nhh>2304 & nhh<=2879
